...
import (
	...
	"github.com/nosborn/ibgames-1999/v2"
	"github.com/nosborn/ibgames-1999/v2/auth"
	"github.com/nosborn/ibgames-1999/v2/db"
)
...
func Login(remoteHostname string) {
	...
	// Argument parsing is already done in main() but was done here.
	...
	for {
		name, err := ReadString("fed99 login: ", reader)
		if err != nil {
			if err == io.EOF {
				os.Exit(0)
			}
